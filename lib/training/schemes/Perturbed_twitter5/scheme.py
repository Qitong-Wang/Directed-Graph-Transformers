...
from lib.models.Perturbed_twitter5 import DIGT_Perturbed_twitter5
from lib.data.Perturbed_twitter5 import Perturbed_twitter5StructuralPEGraphDataset


class Perturbed_twitter5_Training(DIGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name='Perturbed_twitter5',
            dataset_path='cache_data/Perturbed_twitter5',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, Perturbed_twitter5StructuralPEGraphDataset

    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, DIGT_Perturbed_twitter5
...
SCHEME = Perturbed_twitter5_Training
