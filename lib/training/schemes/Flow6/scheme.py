...
from lib.models.Flow6 import DIGT_Flow6
from lib.data.Flow6 import Flow6StructuralPEGraphDataset


class Flow6_Training(DIGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name='Flow6',
            dataset_path='cache_data/Flow6',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, Flow6StructuralPEGraphDataset

    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, DIGT_Flow6
