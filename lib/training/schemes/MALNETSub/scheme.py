...
from lib.models.MALNETSub import DIGT_MALNETSub
from lib.data.MALNETSub import MALNETSubStructuralPEGraphDataset


class MALNETSub_Training(DIGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name='MALNETSub',
            dataset_path='cache_data/MALNETSub',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, MALNETSubStructuralPEGraphDataset

    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, DIGT_MALNETSub
