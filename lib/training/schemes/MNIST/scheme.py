...
from lib.models.MNIST import DIGT_MNIST
from lib.data.MNIST import MNISTStructuralPEGraphDataset

class MNIST_Training(DIGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name    = 'MNIST',
            dataset_path    = 'cache_data/MNIST',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, MNISTStructuralPEGraphDataset
    
    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config,  DIGT_MNIST
    ...
    def prediction_step(self, batch):
        return dict(
            predictions =  self.model(batch), #torch.softmax(self.model(batch),dim=1),
