...
from lib.models.Perturbed_twitter3 import DIGT_Perturbed_twitter3
from lib.data.Perturbed_twitter3 import Perturbed_twitter3StructuralPEGraphDataset


class Perturbed_twitter3_Training(DIGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name='Perturbed_twitter3',
            dataset_path='cache_data/Perturbed_twitter3',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, Perturbed_twitter3StructuralPEGraphDataset

    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config, DIGT_Perturbed_twitter3
...
SCHEME = Perturbed_twitter3_Training
