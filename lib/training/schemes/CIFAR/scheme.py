...
from lib.models.CIFAR import DIGT_CIFAR
from lib.data.CIFAR import CIFARStructuralPEGraphDataset

class CIFAR_Training(DIGT_MOL_Training):
    def get_default_config(self):
        config_dict = super().get_default_config()
        config_dict.update(
            dataset_name    = 'CIFAR',
            dataset_path    = 'cache_data/CIFAR',
    ...
    def get_dataset_config(self):
        ...
        return dataset_config, CIFARStructuralPEGraphDataset
    
    def get_model_config(self):
        model_config, _ = super().get_model_config()
        return model_config,  DIGT_CIFAR
