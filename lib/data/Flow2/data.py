...
class Flow2Dataset(DatasetBase):
    def __init__(self, 
                 dataset_path         ,
                 upto_hop,
                 dataset_name = 'Flow2',
    ...
    def dataset(self):
        try:
            ...
            path = "./raw_data/flow_2_dataset.pkl"
...
class Flow2GraphDataset(GraphDataset,Flow2Dataset):
    pass

class Flow2PEGraphDataset(PEEncodingsGraphDataset,Flow2Dataset):
    pass

class Flow2StructuralGraphDataset(StructuralDataset,Flow2GraphDataset):
    pass

class Flow2StructuralPEGraphDataset(StructuralDataset,Flow2PEGraphDataset):
    pass
