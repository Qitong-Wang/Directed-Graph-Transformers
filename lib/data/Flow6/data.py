...
class Flow6Dataset(DatasetBase):
    def __init__(self, 
                 dataset_path         ,
                 upto_hop,
                 dataset_name = 'Flow6',
    ...
    def dataset(self):
        try:
            ...
            path = "./raw_data/flow_6_dataset.pkl"
...
class Flow6GraphDataset(GraphDataset,Flow6Dataset):
    pass

class Flow6PEGraphDataset(PEEncodingsGraphDataset,Flow6Dataset):
    pass

class Flow6StructuralGraphDataset(StructuralDataset,Flow6GraphDataset):
    pass

class Flow6StructuralPEGraphDataset(StructuralDataset,Flow6PEGraphDataset):
    pass
